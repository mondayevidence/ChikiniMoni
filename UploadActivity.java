...
public class UploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStrorageRef = FirebaseStorage.getInstance().getReference("uploads");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(UploadActivity.this, "Upload is progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
    ...
    private void uploadFile() {
        if (mImageUri != null) {
            StorageReference fileReference = mStrorageRef.child(System.currentTimeMillis() + "." + getFileExtension(mImageUri));
